...
pub mod client_dll { // client.dll
    pub const dwBaseEntityModel_setModel: usize = 0x581530;
    ...
    pub const dwGameEntitySystem_getBaseEntity: usize = 0x604B40;
    pub const dwGameEntitySystem_getHighestEntityIndex: usize = 0x5F6830;
    ...
    pub const dwLocalPlayerPawn: usize = 0x16B7328;
    pub const dwPlantedC4: usize = 0x180EB48;
    pub const dwViewAngles: usize = 0x18690D0;
