...
class client_dll: # client.dll
    dwBaseEntityModel_setModel = 0x581530
    ...
    dwGameEntitySystem_getBaseEntity = 0x604B40
    dwGameEntitySystem_getHighestEntityIndex = 0x5F6830
    ...
    dwLocalPlayerPawn = 0x16B7328
    dwPlantedC4 = 0x180EB48
    dwViewAngles = 0x18690D0
